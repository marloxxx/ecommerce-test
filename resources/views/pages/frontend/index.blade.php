                                            ...
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#{{ $product->id }}"
                                                    title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick
                                                        Shop</span></a>
                                                <a title="Wishlist"
                                                    href="{{ route('wishlist.store', $product->slug) }}"><i
                                                        class=" ti-heart "></i><span>Add to Wishlist</span></a>
                                            </div>
                                            <div class="product-action-2">
                                                <a href="{{ route('cart.store', $product->slug) }}">Add to cart</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="product-content">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="list-image overlay">
                                                ...
                                                @endphp
                                                <img src="{{ $photo[0] }}" alt="{{ $photo[0] }}">
                                                <a href="{{ route('cart.store', $product->slug) }}" class="buy"><i
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12 no-padding">
                                            <div class="content">
                                                ...
                                                <p class="price with-discount">Rp. {{ number_format($product->price, 2) }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="quickview-content">
                                        ...
                                        <div class="quickview-ratting-review">
                                            <div class="quickview-ratting-wrap">
                                                ...
                                                <a href="#"> ({{ $product->rating }} customer review)</a>
                                            </div>

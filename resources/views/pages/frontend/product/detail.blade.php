                            ...
                            <div class="product-des">
                                ...
                                <div class="short">
                                    ...
                                    <div class="rating-main">
                                        <ul class="rating">
                                            @php
                                                $rate = ceil($product_detail->rating);
                                            @endphp
                                            @for ($i = 1; $i <= 5; $i++)
                                                @if ($rate >= $i)
                                        ...
                                        <a href="#" class="total-review">({{ $product_detail->rating }})
                                            Review</a>
                                    </div>
                                    <p class="price"><span class="discount">Rp.
                                            {{ number_format($product_detail->price, 2) }}</span>
                                    </p>
                                ...
                                <div class="product-buy">
                                    ...
                                    <div class="cart.store mt-4">
                                        <button type="submit" class="btn"
                                            onclick="addToCart({{ $product_detail->id }})">
                                            Add to cart</button>
                                        <a href="javascript:void(0)" onclick="addWishList({{ $product_detail->id }})"
                                    ...
                                    @if ($product_detail->category->parent_id != null)
                                        <p class="cat mt-1">Sub Category :<a
                                                href="{{ route('product-sub-cat', [$product_detail->category->parent_info->slug, $product_detail->category->slug]) }}">{{ $product_detail->category->parent_info->title }}</a>
                                        </p>
                                    @endif
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="ratting-main">
                                                        <div class="avg-ratting">
                                                            <h4>{{ ceil($product_detail->rating) }}
                                                                <span>(Overall)</span>
                                                            </h4>
                                                            <span>Based on {{ $product_detail->reviews->count() }}
                                                                Comments</span>
                                                        </div>

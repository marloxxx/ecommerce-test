        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-2 col-md-2 col-12">
                    <!-- Logo -->
                    <div class="logo">
                        <a href="{{ route('home') }}"><img src="{{ $settings->photo }}" alt="logo"></a>
                    </div>
                    <!--/ End Logo -->
                    <!-- Search Form -->
                    ...
                    <div class="search-bar-top">
                        <div class="search-bar">
                            <select>
                                ...
                                @foreach ($categoriesWithChild as $cat)
                    ...
                    <div class="right-bar">
                        ...
                        <div class="sinlge-bar shopping">
                            ...
                            <a href="{{ route('wishlist') }}" class="single-icon"><i class="fa fa-heart-o"></i>
                                <span class="total-count">{{ Auth::check() ? count(Auth::user()->wishlist) : 0 }}
                                </span></a>
                            <!-- Shopping Item -->
                            @auth
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        <span>{{ count(getAllProductFromWishlist()) }}
                                            Items</span>
                                        <a href="{{ route('wishlist') }}">View Wishlist</a>
                                    </div>
                                    <ul class="shopping-list">
                                        @foreach (getAllProductFromWishlist() as $data)
                                            @php
                                    ...
                                    <div class="bottom">
                                        <div class="total">
                                            <span>Total</span>
                                            <span class="total-amount">${{ number_format(totalWishlistPrice(), 2) }}</span>
                                        </div>
                        ...
                        <div class="sinlge-bar shopping">
                            <a href="{{ route('cart') }}" class="single-icon"><i class="ti-bag"></i>
                                <span class="total-count">{{ Auth::check() ? count(Auth::user()->carts) : 0 }}
                                </span></a>
                            <!-- Shopping Item -->
                            @auth
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        <span>{{ count(getAllProductFromCart()) }} Items</span>
                                    ...
                                    <ul class="shopping-list">
                                        @foreach (getAllProductFromCart() as $data)
                                            ...
                                            @endphp
                                            <li>
                                                <a href="javascript:void(0)" onclick="deleteCart({{ $data->id }})"
                                    ...
                                    <div class="bottom">
                                        <div class="total">
                                            <span>Total</span>
                                            <span class="total-amount">${{ number_format(totalCartPrice(), 2) }}</span>
                                        </div>
                                ...
                                <div class="navbar-collapse">
                                    <div class="nav-inner">
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="@if (request()->is('product-grids') || request()->is('product-lists')) active @endif"><a
